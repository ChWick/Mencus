...
public:
  ...
  Ogre::Real getRight() const {return m_vPosition.x + m_vSize.x;}
  Ogre::Real getLeft() const {return m_vPosition.x;}
  Ogre::Real getTop() const {return m_vPosition.y + m_vSize.y;}
  Ogre::Real getBottom() const {return m_vPosition.y;}
